...
<#--		<script type="text/javascript" src="/user/js/hp.js" ></script>-->
		<title></title>
	</head>
	<body>
		<div id="main">
			...
			<div class="container">
				<div class="c2">
					...
					<p style="font-size: 16px">从这里开启奇妙之旅</p>
				</div>
				<div class="c3">
					<form>
						<div class="form-group">
  						...
  						<div class="c3-1">
							<button id="denglu" type="button" class="btn btn-default btn1" onclick="d()">登录</button>
							<a href="/register" type="button" class="btn btn-default btn2">注册</a>
						</div>
					</form>
				</div>
			</div>
		...
		<ul class="cbl" >
			...
			<i class="clearfix"></i>
			<li ><a  href="#">
				<div class="icon d4" data-toggle="tooltip" data-placement = "left" title="<img src='/user/img/erweima.png'><br/> 关注微信 " data-html="true"><i class="i4"></i></div>
			</a></li>
		</ul>
		</div>
	</body>
	...
	<script>
		function d(){
			...
			if ($("#username").val() == "" || $("#psw").val() == "") {
				...
				console.log(10);
				$.ajax({
				url:"/login2/"+username+"/"+password,//所要提交数据的服务器地址
				type:"POST",
				dataType:"json",
